...
export function InteractiveHoverButton({
  ...
  const commonClass = cn(
    "relative w-full sm:w-48 cursor-pointer overflow-hidden p-3 px-6 text-center text-xl font-black uppercase transition-all duration-300 ease-in-out active:scale-[0.98] [transform:translate3d(0,0,0)] [backface-visibility:hidden] will-change-transform",
    borderRadiusClass,
    baseClass,
    className
  );
  ...
  const innerContent = (
    <div className="relative z-10 flex items-center justify-center w-full h-full">
      ...
      <div className="flex items-center gap-2.5 relative transition-transform duration-[450ms] ease-in-out group-data-[hover=true]:-translate-x-3 will-change-transform [transform:translate3d(0,0,0)]">
        ...
        {icon ? (
          <div className="relative flex items-center justify-center shrink-0 z-10">
            ...
            <div 
              className={cn(
                "absolute inset-0 m-auto h-2.5 w-2.5 transition-transform duration-300 ease-in-out scale-0 group-data-[hover=true]:scale-[100.8] group-data-[hover=true]:duration-[900ms] group-data-[hover=true]:ease-out origin-center shrink-0 z-[-1] will-change-transform [transform:translate3d(0,0,0)]", 
                dotRoundingClass,
                dotClass
              )}
            ></div>
          ...
          <div 
            className={cn(
              "relative z-0 h-2.5 w-2.5 transition-transform duration-300 ease-in-out group-data-[hover=true]:scale-[100.8] group-data-[hover=true]:duration-[900ms] group-data-[hover=true]:ease-out origin-center shrink-0 will-change-transform [transform:translate3d(0,0,0)]", 
              dotRoundingClass,
              dotClass
            )}
          ></div>
        ...
        <span className={cn("relative z-10 transition-colors duration-300 ease-in-out group-data-[hover=true]:duration-[450ms] select-none whitespace-nowrap [transform:translate3d(0,0,0)]", textClass)}>
          {content}
        </span>
        ...
        <div 
          className={cn(
            "absolute left-full ml-2 z-10 flex items-center transition-all duration-[450ms] ease-in-out group-data-[hover=true]:duration-[650ms] group-data-[hover=true]:ease-out opacity-0 -translate-x-2 group-data-[hover=true]:translate-x-0 group-data-[hover=true]:opacity-100 shrink-0 [transform:translate3d(0,0,0)]",
            arrowClass
          )}
        >
