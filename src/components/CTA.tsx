...
export default function CTA({ dict }: { dict: Record<string, string> }) {
  ...
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const _activeAnomaly = anomalies[anomalyIndex];
  ...
  // GPU killswitch — kept for the disabled Canvas block
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const _isCanvasInView = useInView(ctaRef, { margin: "0px 0px 0px 0px" });
